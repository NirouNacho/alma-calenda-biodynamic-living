...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Byz8kvXk.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BUnO4HPk.js").then((n2) => n2.r),
    import("./start-_X_uNXqH.js"),
...
export {
  ...
  decodePath as h,
  deepEqual as i,
  dummyMatchContext as j,
  encodePathLikeUrl as k,
  escapeHtml as l,
  exactPathTest as m,
  executeRewriteInput as n,
  executeRewriteOutput as o,
  findFlatMatch as p,
  findRouteMatch as q,
  findSingleMatch as r,
  functionalUpdate as s,
  getAssetCrossOrigin as t,
  hasKeys as u,
  interpolatePath as v,
  invariant as w,
  isDangerousProtocol as x,
  isInlinableStylesheet as y,
  isModuleNotFoundError as z
};
