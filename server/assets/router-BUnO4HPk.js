...
const appCss = "/assets/styles-C1invQzz.css";
...
const $$splitComponentImporter$3 = () => import("./misticismo-organico-5CeEmWiK.js");
const Route$3 = createFileRoute("/misticismo-organico")({
  head: () => ({
    meta: [{
      title: "Misticismo Orgánico · Alma Calenda"
    }, {
      name: "description",
      content: "Dirección visual fresca y botánica para Alma Calenda — accesible y luminosa."
    }],
    links: [{
      rel: "stylesheet",
...
const $$splitComponentImporter$2 = () => import("./huerto-sereno-CQX4l9CC.js");
const Route$2 = createFileRoute("/huerto-sereno")({
  head: () => ({
    meta: [{
      title: "Huerto Sereno · Alma Calenda"
    }, {
      name: "description",
      content: "Dirección visual cálida y terrenal para Alma Calenda — almanaque biodinámico."
    }],
    links: [{
      rel: "stylesheet",
...
const $$splitComponentImporter$1 = () => import("./cosmos-biodinamico-CPZVRNbE.js");
const Route$1 = createFileRoute("/cosmos-biodinamico")({
  head: () => ({
    meta: [{
      title: "Cosmos Biodinámico · Alma Calenda"
    }, {
      name: "description",
      content: "Dirección visual premium y espiritual para Alma Calenda — calendario cósmico."
    }],
    links: [{
      rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-DimHz6oN.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tres direcciones visuales para la app de agricultura biodinámica Alma Calenda. Elige la que más te conecte."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const MisticismoOrganicoRoute = Route$3.update({
  id: "/misticismo-organico",
  path: "/misticismo-organico",
  getParentRoute: () => Route$4
});
const HuertoSerenoRoute = Route$2.update({
  id: "/huerto-sereno",
  path: "/huerto-sereno",
  getParentRoute: () => Route$4
});
const CosmosBiodinamicoRoute = Route$1.update({
...
const rootRouteChildren = {
  IndexRoute,
  CosmosBiodinamicoRoute,
  HuertoSerenoRoute,
  MisticismoOrganicoRoute
};
